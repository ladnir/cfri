...
```text
docs/rfc_distance_analysis/rfc_restricted_rank_conjecture.md
```
...
For the exact depth-3 rows, the feature tables in `docs/rfc_distance_analysis/rank_tree_feature_row_*` show that
persistent defects are isolated by a small number of `(s_identity, z_parity, I_l, P_l)` buckets.
The regression script:

```text
python scripts/rfc_distance_analysis/test_tree_collision_rule.py \
  docs/rfc_distance_analysis/rank_tree_feature_row_s6_zp2_systematic_p65537_depth3_c8.csv \
  docs/rfc_distance_analysis/rank_tree_feature_row_s5_zp3_systematic_p65537_depth3_c8.csv \
  docs/rfc_distance_analysis/rank_tree_feature_row_s6_zp3_systematic_p65537_depth3_c8.csv \
  --out docs/rfc_distance_analysis/rank_tree_collision_rule_depth3_exact_rows.csv
```
...
```text
python scripts/rfc_distance_analysis/rank_tree_feature_row.py \
  --depth 4 \
  --total-expansion 8 \
  --prime 65537 \
  --seed 307 \
  ...
  --z-parity 5 \
  --shape-samples 20000 \
  --out docs/rfc_distance_analysis/rank_tree_feature_sample_s11_zp5_systematic_p65537_depth4_c8.csv
```
...
```text
docs/rfc_distance_analysis/rfc_original_mds_certificate.md
```
