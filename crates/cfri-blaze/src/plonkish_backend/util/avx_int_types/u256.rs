...
use core::arch::x86_64::{_mm256_and_si256, _mm256_xor_epi64};
...
impl BitXor for Blazeu256 {
    ...
    fn bitxor(self, rhs: Self) -> Self {
        unsafe {
            Self {
                value: _mm256_xor_epi64(self.value, rhs.value),
            }
        }
    }
}
...
impl BitAnd for Blazeu256 {
    ...
    fn bitand(self, rhs: Self) -> Self {
        unsafe {
            Self {
                value: _mm256_and_si256(self.value, rhs.value),
            }
        }
    }
}
...
impl Zero for Blazeu256 {
    fn zero() -> Blazeu256 {
        Self {
            value: u256::from(u8x32::from_array([0; 32])),
        }
    }
