...
pub use crate::backend::basefold::{
    ...
    BasefoldVerifierParams, HidingBasefold, HidingBasefoldCommitment, HidingBasefoldParams,
    HidingBasefoldProverParams, HidingBasefoldVerifierParams, Type1Polynomial, Type2Polynomial,
};
pub use crate::backend::blaze;
use crate::backend::{
    arithmetic::Field,
    end_timer, izip,
    parallel::parallelize,
    poly::{multilinear::MultilinearPolynomial, Polynomial},
    start_timer, Error, Itertools,
};

pub(crate) fn validate_input<'a, F: Field>(
    function: &str,
...
pub(crate) mod test {
    ...
    fn test_transcript() {
        ...
        use crate::backend::transcript::FieldTranscript;
    ...
    pub(crate) fn run_commit_open_verify<F, Pcs, T>()
    where
        F: PrimeField,
        Pcs: PolynomialCommitmentScheme<F, Polynomial = MultilinearPolynomial<F>>,
    ...
    pub(crate) fn run_batch_commit_open_verify<F, Pcs, T>()
    where
        F: PrimeField,
        Pcs: PolynomialCommitmentScheme<F, Polynomial = MultilinearPolynomial<F>>,
        T: TranscriptRead<Pcs::CommitmentChunk, F>
