...
\begin{description}[leftmargin=0.3in,style=nextline]
  ...
  \item[MLPCS.]
        Multilinear polynomial commitment service/scheme: our name for the
        ideal commit-and-evaluate interface that Blaze calls an MLIOP.  The
        prover registers Boolean tensors with an ideal evaluation functionality
        that answers MLE evaluations.
  \item[Sumcheck.]
...
\begin{itemize}
  ...
  \item[\textbf{[BKS18]}] Ben-Sasson, Kopparty, and Saraf,
