use crate::plonkish_backend::util::avx_int_types::BlazeField;
use crate::plonkish_backend::util::avx_int_types::B128;
use crate::plonkish_backend::util::Deserialize;
use crate::plonkish_backend::util::Deserializer;
use crate::plonkish_backend::util::Serialize;
use crate::plonkish_backend::util::Serializer;
use core::arch::x86_64::__m512i as u512;
use core::arch::x86_64::{_mm512_and_epi64, _mm512_xor_epi64};
...
impl BitXor for Blazeu512 {
    ...
    fn bitxor(self, rhs: Self) -> Self {
        unsafe {
            Self {
                value: _mm512_xor_epi64(self.value, rhs.value),
            }
        }
    }
}
...
impl BitAnd for Blazeu512 {
    ...
    fn bitand(self, rhs: Self) -> Self {
        unsafe {
            Self {
                value: _mm512_and_epi64(self.value, rhs.value),
            }
        }
    }
}
...
impl Zero for Blazeu512 {
    fn zero() -> Blazeu512 {
        Self {
            value: u512::from(u8x64::from_array([0; 64])),
        }
    }
