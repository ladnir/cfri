...
```text
scripts/rfc_distance_analysis/rfc_split_profile.py
```
...
```text
docs/rfc_distance_analysis/rfc_split_profile_depth2_examples.csv
docs/rfc_distance_analysis/rfc_split_profile_bad_s6_zp3_systematic_p65537_depth3_c8_resample5.summary.csv
docs/rfc_distance_analysis/rfc_split_profile_bad_s5_zp3_systematic_p65537_depth3_c8_resample5.summary.csv
docs/rfc_distance_analysis/rfc_split_profile_feature_bad_s11_zp5_systematic_p65537_depth4_c8.summary.csv
docs/rfc_distance_analysis/rfc_split_profile_feature_bad_s14_zp3_systematic_p65537_depth4_c8.summary.csv
```
...
```text
scripts/rfc_distance_analysis/rfc_certified_defect_row.py
```
...
```text
docs/rfc_distance_analysis/rfc_certified_defect_row_s2_zp2_depth2_c8.csv
docs/rfc_distance_analysis/rfc_certified_defect_row_s6_zp2_depth3_c8.csv
docs/rfc_distance_analysis/rfc_certified_defect_row_s6_zp3_depth3_c8.csv
docs/rfc_distance_analysis/rfc_certified_defect_row_s5_zp3_depth3_c8.csv
```
...
```text
scripts/rfc_distance_analysis/rfc_certified_extension_check.py
```
...
```text
docs/rfc_distance_analysis/rfc_certified_extension_s6_zp2_to_zp4_depth3_c8.csv
docs/rfc_distance_analysis/rfc_certified_extension_s6_zp4_to_zp5_depth3_c8.csv
docs/rfc_distance_analysis/rfc_certified_extension_s5_zp3_to_zp4_depth3_c8.csv
docs/rfc_distance_analysis/rfc_certified_extension_s5_zp4_to_zp5_depth3_c8.csv
docs/rfc_distance_analysis/rfc_certified_target_sample_z10_depth3_c8.csv
docs/rfc_distance_analysis/rfc_certified_target_sample_z11_depth3_c8.csv
docs/rfc_distance_analysis/rfc_extension_rank_resample_s6_zp4_depth3_c8.csv
docs/rfc_distance_analysis/rfc_extension_rank_resample_s4_zp6_depth3_c8.csv
```
...
```text
docs/rfc_distance_analysis/rfc_certified_target_sample_z17_depth4_c8_safe1k.csv
docs/rfc_distance_analysis/rfc_certified_target_sample_z18_depth4_c8_safe1k.csv
docs/rfc_distance_analysis/rfc_certified_target_sample_z19_depth4_c8_safe1k.csv
docs/rfc_distance_analysis/rfc_certificate_rank_resample_depth4_z17_c8.csv
```
...
```text
docs/rfc_distance_analysis/rfc_systematic_collapse_family.md
```
