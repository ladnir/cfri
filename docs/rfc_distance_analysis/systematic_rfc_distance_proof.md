...
This is the exact theorem-side quantity checked by `scripts/rfc_distance_analysis/verify_systematic_rfc_certificate.py`.
...
1. `scripts/rfc_distance_analysis/systematic_rfc_bound.py` emits threshold tables.
2. `scripts/rfc_distance_analysis/verify_systematic_rfc_certificate.py` independently checks the theorem conditions from
...
The file `docs/rfc_distance_analysis/systematic_rfc_c8_depth8_certificate.csv` is the main small checked toy certificate.
It was emitted with:

```text
python scripts/rfc_distance_analysis/systematic_rfc_bound.py \
  --depth 8 \
  --parity-expansion 7 \
  --field-bits 128 \
  --security-bits 40 \
  ...
  --monotone-thresholds \
  --emit-certificate \
  --certificate-path docs/rfc_distance_analysis/systematic_rfc_c8_depth8_certificate.csv \
  --full-thresholds-path docs/rfc_distance_analysis/systematic_rfc_c8_depth8_thresholds.csv
```

and independently verified with:

```text
python scripts/rfc_distance_analysis/verify_systematic_rfc_certificate.py \
  docs/rfc_distance_analysis/systematic_rfc_c8_depth8_thresholds.csv \
  --field-bits 128 \
  --security-bits 40
```
...
`docs/rfc_distance_analysis/systematic_rfc_c8_depth8_security80_certificate.csv` and
`docs/rfc_distance_analysis/systematic_rfc_c8_depth8_security80_thresholds.csv`. It verifies with:
...
`docs/rfc_distance_analysis/systematic_rfc_c8_depth8_global80_certificate.csv` and
`docs/rfc_distance_analysis/systematic_rfc_c8_depth8_global80_thresholds.csv`. The verifier command is:

```text
python scripts/rfc_distance_analysis/verify_systematic_rfc_certificate.py \
  docs/rfc_distance_analysis/systematic_rfc_c8_depth8_global80_thresholds.csv \
  --field-bits 128 \
  --security-bits 83
```
...
`docs/rfc_distance_analysis/systematic_rfc_c8_depth9_global80_certificate.csv` and
`docs/rfc_distance_analysis/systematic_rfc_c8_depth9_global80_thresholds.csv`. The verifier command is:

```text
python scripts/rfc_distance_analysis/verify_systematic_rfc_certificate.py \
  docs/rfc_distance_analysis/systematic_rfc_c8_depth9_global80_thresholds.csv \
  --field-bits 128 \
  --security-bits 84
```
...
`docs/rfc_distance_analysis/systematic_rfc_c8_depth10_global80_certificate.csv` and
`docs/rfc_distance_analysis/systematic_rfc_c8_depth10_global80_thresholds.csv`. The verifier command is:

```text
build/systematic_rfc_cert_cpp/systematic_rfc_cert.exe \
  --verify docs/rfc_distance_analysis/systematic_rfc_c8_depth10_global80_thresholds.csv \
  --field-bits 128 \
  --security-bits 84
```
...
The depth-11 artifact is in `docs/rfc_distance_analysis/systematic_rfc_c8_depth11_global80_certificate.csv` and
`docs/rfc_distance_analysis/systematic_rfc_c8_depth11_global80_thresholds.csv`. It reports:
...
The file `docs/rfc_distance_analysis/systematic_rfc_c8_depth6_certificate.csv` is an example certificate summary emitted
by:
...
python scripts/rfc_distance_analysis/systematic_rfc_bound.py \
  ...
  --monotone-thresholds \
  --emit-certificate \
  --certificate-path docs/rfc_distance_analysis/systematic_rfc_c8_depth6_certificate.csv \
  --full-thresholds-path docs/rfc_distance_analysis/systematic_rfc_c8_depth6_thresholds.csv
```
...
The companion `docs/rfc_distance_analysis/systematic_rfc_c8_depth6_thresholds.csv` contains every threshold `B_i(s)` used
...
```text
python scripts/rfc_distance_analysis/verify_systematic_rfc_certificate.py \
  docs/rfc_distance_analysis/systematic_rfc_c8_depth6_thresholds.csv \
  --field-bits 128 \
  --security-bits 40
```
...
Tiny exact checks are available through `scripts/rfc_distance_analysis/exhaustive_systematic_rfc.py`. For example, for
GF(5), depth 3:

```text
python scripts/rfc_distance_analysis/exhaustive_systematic_rfc.py \
  --p 5 \
  --depth 3 \
  --total-expansion 8 \
  --seed 1 \
