...
```text
docs/rfc_distance_analysis/rfc_near_extremizer_total_union_depth11_c8_e128.csv
```
...
```text
docs/rfc_distance_analysis/rfc_near_extremizer_total_union_depth11_c8_e128_cumulative.csv
```
...
```text
docs/rfc_distance_analysis/rfc_near_extremizer_total_union_depth11_c8_e128_stride_dim.csv
docs/rfc_distance_analysis/rfc_near_extremizer_total_union_depth11_c8_e128_cumulative_stride_dim.csv
```
...
```text
docs/rfc_distance_analysis/rfc_near_extremizer_total_union_depth11_c8_e128_stride_dim_overhead16.csv
docs/rfc_distance_analysis/rfc_near_extremizer_total_union_depth11_c8_e128_stride_dim_overhead32.csv
docs/rfc_distance_analysis/rfc_near_extremizer_total_union_depth11_c8_e128_stride_dim_overhead64.csv
```

Additional stress artifacts:

```text
docs/rfc_distance_analysis/rfc_near_extremizer_total_union_depth11_c8_e128_stride_dim_overhead104.csv
docs/rfc_distance_analysis/rfc_near_extremizer_total_union_depth11_c8_e128_stride_dim_overhead108.csv
```
...
```text
docs/rfc_distance_analysis/rfc_counted_charged_tree_theorem.md
docs/rfc_distance_analysis/rfc_defect_coupled_virtual_core_theorem.md
```
...
```text
docs/rfc_distance_analysis/rfc_near_extremizer_total_union_depth11_c8_e128_stride_dim_overhead64_holes_coupled_extra.csv
...
```text
docs/rfc_distance_analysis/rfc_core_containment_depth4_m4_w5.csv
docs/rfc_distance_analysis/rfc_core_containment_depth4_m2_w9.csv
docs/rfc_distance_analysis/rfc_core_containment_depth4_m2_w10.csv
docs/rfc_distance_analysis/rfc_core_containment_depth4_m4_e2_model.csv
docs/rfc_distance_analysis/rfc_core_containment_depth4_m4_e3_model.csv
...
```text
docs/rfc_distance_analysis/rfc_near_defect_charge_injection.md
docs/rfc_distance_analysis/rfc_core_preservation_hall_condition.md
docs/rfc_distance_analysis/rfc_counted_charged_tree_theorem.md
docs/rfc_distance_analysis/rfc_near_core_containment_theorem.md
docs/rfc_distance_analysis/rfc_near_kernel_line_lemma.md
