...
```text
scripts/rfc_distance_analysis/rfc_uncertainty_check.py
```
...
```text
scripts/rfc_distance_analysis/rfc_one_copy_kernel_envelope.py
```
...
```text
docs/rfc_distance_analysis/rfc_uncertainty_stability.md
```
...
```text
scripts/rfc_distance_analysis/rfc_collapse_intersection_moment.py
```
...
```text
docs/rfc_distance_analysis/rfc_collapse_intersection_moment_c8_depth1_to_11.csv
```
