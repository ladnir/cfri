...
| Backend compiler-parity query values and multiproof nodes | 32 | 16 | Top authentication is merged into the shared round-0 backend layer proof. |
...
- The current fixture remains pinned at `6,368` B128 bytes and `5,376` projected bytes until a
...
compiler parity layer multiproof nodes: 384 bytes in the B128 fixture
auxiliary multiproof nodes: 0 bytes in the B128 fixture
```
