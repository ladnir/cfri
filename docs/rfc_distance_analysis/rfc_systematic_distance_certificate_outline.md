...
```text
docs/rfc_distance_analysis/rfc_systematic_c8_depth11_certificate_statement.md
```
...
```text
docs/rfc_distance_analysis/rfc_conditioned_copy_tail_depth11_q128.csv
```
...
```text
docs/rfc_distance_analysis/rfc_extremizer_second_copy_check_depth4_m2.csv
...
```text
docs/rfc_distance_analysis/rfc_near_stability_proof_strategy.md
```

and the theorem-style near-stability draft is:

```text
docs/rfc_distance_analysis/rfc_near_stability_theorem_draft.md
```
...
```text
docs/rfc_distance_analysis/rfc_near_extremizer_slack_all_m_depth11_c8.csv
```
