...
use crate::pip_fri::util::merkle_tree::MerkleTreeVerifier;
...
#[cfg(test)]
mod tests {
    use crate::deepfold::{prover::Prover, verifier::Verifier};
    use crate::pip_fri::util::helper::{Helper, MultilinearPolynomial};
    use crate::pip_fri::util::{CODE_RATE, SECURITY_BITS};
    use ark_ff::PrimeField;
    use ark_poly::{EvaluationDomain, GeneralEvaluationDomain};
    const STEP: usize = 1;
    const SIZE: usize = 20;
    use crate::deepfold::prover::RandomOracle;
    use crate::pip_fri::util::goldilocks::Goldilocks as T;
    ...
    #[test]
    fn open_verify_small() {
        let proof_size = output_proof_size::<T>(6);
        assert!(proof_size > 0);
    }

    #[test]
    #[ignore = "large parameter proof-size experiment; keep default tests under one second"]
    fn test_proof_size() {
