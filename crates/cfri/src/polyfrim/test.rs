...
mod tests {
    ...
    use crate::polyfrim::{prover::One2ManyProver, verifier::One2ManyVerifier};
    ...
    fn polyfrim_test() {
        ...
        let mut prover =
            One2ManyProver::new(variable_num, &interpolate_cosets, polynomial, &oracle);
