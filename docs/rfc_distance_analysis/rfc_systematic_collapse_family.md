...
```text
scripts/rfc_distance_analysis/rfc_systematic_collapse_family.py
```
...
```text
docs/rfc_distance_analysis/rfc_systematic_collapse_family_depth5_c8_rank.csv
```
...
```text
docs/rfc_distance_analysis/rfc_systematic_collapse_family_depth4_c8_livebits2.csv
docs/rfc_distance_analysis/rfc_systematic_collapse_family_depth4_c8_livebits2_rank.csv
docs/rfc_distance_analysis/rfc_systematic_collapse_family_depth5_c8_livebits2.csv
docs/rfc_distance_analysis/rfc_systematic_collapse_family_depth5_c8_livebits2_rank.csv
docs/rfc_distance_analysis/rfc_systematic_collapse_family_depth6_c8_livebits3.csv
docs/rfc_distance_analysis/rfc_systematic_collapse_family_depth6_c8_livebits3_rank.csv
```

The ceiling table:

```text
docs/rfc_distance_analysis/rfc_systematic_collapse_ceiling_c8_depth1_to_11.csv
```
...
```text
docs/rfc_distance_analysis/rfc_systematic_threshold_vs_collapse_ceiling_c8_depth1_to_11.csv
```
