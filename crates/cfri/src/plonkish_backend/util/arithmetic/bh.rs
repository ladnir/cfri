use crate::plonkish_backend::util::{expression::Rotation, parallel::par_map_collect};
...
mod test {
    use crate::plonkish_backend::util::{arithmetic::BooleanHypercube, expression::Rotation};
