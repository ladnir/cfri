...
The script `scripts/rfc_distance_analysis/systematic_rfc_bound.py` implements the first support-stratified recurrence in
...
The script `scripts/rfc_distance_analysis/exhaustive_systematic_rfc.py` builds paper-style RFC generator matrices over
...
The current `scripts/rfc_distance_analysis/systematic_rfc_bound.py` is a research calculator. To become a certificate
generator, it needs:
