...
```text
docs/rfc_distance_analysis/rfc_near_pair_kernel_dim_depth4_m4_w5.csv
docs/rfc_distance_analysis/rfc_near_pair_kernel_dim_depth4_m2_w9.csv
docs/rfc_distance_analysis/rfc_near_pair_kernel_dim_depth4_m2_w10.csv
```
...
```text
docs/rfc_distance_analysis/rfc_uncertainty_near_model_pairs_depth4_m4_e2.csv
```
...
```text
scripts/rfc_distance_analysis/rfc_classify_near_core_dimension.py
```
