...
```text
docs/rfc_distance_analysis/rfc_systematic_uncertainty_route.md
```
...
```text
docs/rfc_distance_analysis/rfc_uncertainty_exact_stability_proof.md
```
...
```text
scripts/rfc_distance_analysis/rfc_uncertainty_extremizer_scan.py
```
...
```text
docs/rfc_distance_analysis/rfc_uncertainty_extremizer_scan_depth3_m2.csv
docs/rfc_distance_analysis/rfc_uncertainty_extremizer_pairs_depth3_m2.csv
docs/rfc_distance_analysis/rfc_uncertainty_extremizer_scan_depth3_m4.csv
docs/rfc_distance_analysis/rfc_uncertainty_extremizer_pairs_depth3_m4.csv
docs/rfc_distance_analysis/rfc_uncertainty_extremizer_scan_depth4_m2.csv
docs/rfc_distance_analysis/rfc_uncertainty_extremizer_pairs_depth4_m2.csv
docs/rfc_distance_analysis/rfc_uncertainty_extremizer_scan_depth4_m4.csv
docs/rfc_distance_analysis/rfc_uncertainty_extremizer_pairs_depth4_m4.csv
```
...
```text
docs/rfc_distance_analysis/rfc_uncertainty_near_extremizer_scan_depth4_m4_w5.csv
docs/rfc_distance_analysis/rfc_uncertainty_near_extremizer_pairs_depth4_m4_w5.csv
docs/rfc_distance_analysis/rfc_uncertainty_near_extremizer_class_depth4_m4_w5.csv
docs/rfc_distance_analysis/rfc_uncertainty_near_extremizer_scan_depth4_m2_w9.csv
docs/rfc_distance_analysis/rfc_uncertainty_near_extremizer_pairs_depth4_m2_w9.csv
docs/rfc_distance_analysis/rfc_uncertainty_near_extremizer_class_depth4_m2_w9.csv
docs/rfc_distance_analysis/rfc_uncertainty_near_extremizer_scan_depth4_m2_w10.csv
docs/rfc_distance_analysis/rfc_uncertainty_near_extremizer_pairs_depth4_m2_w10.csv
docs/rfc_distance_analysis/rfc_uncertainty_near_extremizer_class_depth4_m2_w10.csv
```
...
```text
docs/rfc_distance_analysis/rfc_near_extremizer_count_depth11_m32.csv
```
...
```text
docs/rfc_distance_analysis/rfc_near_extremizer_slack_depth11_m32_c8.csv
```
