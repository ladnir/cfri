...
```text
docs/rfc_distance_analysis/rfc_product_recurrence.md
```
...
python scripts/analyze_one_step_categories.py \
  ...
  --old-cutoff 16 \
  --systematic-cutoff 20 \
  --out docs/rfc_distance_analysis/sample_one_step_projection_analysis_gf5_depth3_c8_cpp.csv
```
...
python scripts/compressed_one_step_crossing.py \
  ...
  --prime 5 \
  --total-n 64 \
  --out docs/rfc_distance_analysis/sample_one_step_compressed_crossing_gf5_depth3_c8_cpp
```
...
```text
docs/rfc_distance_analysis/sample_one_step_compressed_crossing_gf5_depth3_c8_cpp.png
```
