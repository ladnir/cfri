...
```text
docs/rfc_distance_analysis/rfc_global_rank_cancellation_probe_depth3_e2_h1.csv
docs/rfc_distance_analysis/rfc_global_rank_cancellation_probe_depth4_e2_h1.csv
docs/rfc_distance_analysis/rfc_global_rank_cancellation_probe_depth5_e1_h1.csv
docs/rfc_distance_analysis/rfc_global_rank_cancellation_probe_depth5_live3_e2_h1_random.csv
docs/rfc_distance_analysis/rfc_global_rank_cancellation_probe_depth5_live4_e2_h1_random.csv
docs/rfc_distance_analysis/rfc_global_rank_cancellation_probe_depth6_live3_e2_h1_random.csv
docs/rfc_distance_analysis/rfc_global_rank_cancellation_probe_depth6_live4_e2_h1_random.csv
docs/rfc_distance_analysis/rfc_global_rank_cancellation_probe_depth6_live5_e2_h1_random.csv
```
