...
mod tests {
    ...
    use crate::fri::prover::{BatchProver, Prover};
    use crate::fri::verifier::{BatchVerifier, Verifier};
    use crate::pip_fri::util::{goldilocks::Goldilocks as T, CODE_RATE, SECURITY_BITS};
    use ark_ff::UniformRand;
    use ark_poly::DenseUVPolynomial;
    use ark_poly::EvaluationDomain;
    // use ark_ff::PrimeField;
    use crate::pip_fri::util::fiat_shamir::RandomOracle;
    use crate::pip_fri::util::{helper::Helper, merkle_tree::MERKLE_ROOT_SIZE};
